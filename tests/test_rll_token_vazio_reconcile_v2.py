...
from tools.rll_token_vazio_reconcile_v2 import DEFAULT_INPUT, DEFAULT_OVERRIDES, DEFAULT_RULES, build_current_view, merge_input_delta
...
class RLLTokenVazioReconcileV2Tests(unittest.TestCase):
    ...
    def test_act_materialization_resolves_only_to_posterior_successor(self):
        ...
        self.assertIs(materialization["evidence_verified"], True)
    ...
    def test_h0_rd_is_reduced_not_falsely_resolved(self):
        ...
        self.assertIs(crosscheck["evidence_verified"], True)
    ...
    def test_582_label_is_reduced_to_current_35_ref_semantic_review(self):
        ...
        self.assertIs(historical["evidence_verified"], True)
    ...
    def test_input_delta_rejects_duplicate_existing_token(self):
        ...
        delta = {"schema": "rll.gap_closure_input_delta.v1", "claim_allowed": False, "tokens": [dict(base["tokens"][0])]}
    ...
    def test_v2_chain_metadata_is_explicit_and_ordered(self):
        ...
        self.assertIs(receipt["policy"]["input_deltas_preserve_prior_denominator_history"], True)
        self.assertIs(receipt["policy"]["override_order_is_explicit"], True)
