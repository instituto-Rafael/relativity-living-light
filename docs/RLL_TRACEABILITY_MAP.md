...
| Fibonacci modular, (T^7) discreto, razão icosaédrica e malha 420 | DERIVED_MATHEMATICALLY / claim-gated | `docs/science/FIBONACCI_MODULAR_ICOSAHEDRAL_PHASE_LATTICE_BRIDGE_20260905.md` | manter fora das fórmulas físicas canônicas; exigir mapa dimensional, dinâmica, observável, likelihood e baseline antes de qualquer ponte cosmológica |
