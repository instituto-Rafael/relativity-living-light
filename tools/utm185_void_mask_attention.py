...
def masked_hyperbolic_attention(
    ...
    *,
    ...
    invalid, the function fails closed with a zero context and a typed state.
    """
    ...
    logits = {
        i: -poincare_distance(query, keys[i]) / temperature
    ...
    weights = [
        (exp_scores[i] / total) if i in exp_scores else 0.0
