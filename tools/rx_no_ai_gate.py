...
active_files = sorted((ROOT / "rx").glob("*.py")) + [
    ...
    ROOT / "tools" / "validate_real_data_materialization_security.py",
    ROOT / "scripts" / "materialize_real_data_guarded.py",
    ROOT / "tools" / "validate_ci_scientific_skills_stdlib_migration.py",
    ROOT / "tools" / "ci_scientific_skills.py",
