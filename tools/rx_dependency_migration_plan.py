...
replacement = {
    ...
    "emcee": "TOKEN_VAZIO_EMCEE_PARITY__RX_MH_BASELINE_AVAILABLE",
    "dynesty": "TOKEN_VAZIO_NESTED_EVIDENCE_REPLACEMENT",
    "astropy": "RX_DHA_ANGULAR_BASELINE__ASTROPY_PARITY_TOKEN_VAZIO",
