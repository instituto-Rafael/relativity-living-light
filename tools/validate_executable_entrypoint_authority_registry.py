...
def main():
    ...
    for row in reg.get("routes",[]):
        ...
        if rid in {"RLL_RX_REAL_VALIDATION_V1","RLL_RX_MULTIPROBE_V1","RLL_RX_CLI_DEVELOPMENT_V1","RLL_FREESTANDING_REAL_KERNEL","STRUCTURE_D_RX_SUCCESSOR","SECURITY_AUDIT"} and rid not in purpose_ids:
